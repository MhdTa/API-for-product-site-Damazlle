        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="tel" id="tel" placeholder="Your Phone Number" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email') border-red-500 @enderror" value="{{ old('tel') }}">
